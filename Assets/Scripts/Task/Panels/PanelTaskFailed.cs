...
public class PanelTaskFailed : MonoBehaviour
{
    ...
    public void ReloadLevel()
    {
        ...
        int sceneNumber = TaskController.Instance.GetSceneNumber(); 
        LevelController.Instance.LoadSceneByIndex(sceneNumber); //индекс сцены получать
    }
}
